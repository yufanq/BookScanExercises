...
/**
*  <p>Title: CustomPaperController</p>
*  <p>Description: </p>
*  <p>Company: </p>
*  @author BOY
*  @date 2018年5月30日 下午9:41:28
*/
@Controller
...
public class CustomPaperController {
	...
	private static final String paperType="自定义"; 
	...
	public ModelAndView selectAllPapers(String page){
		...
		modelAndView.addObject("customPapers", selectAllPapers);
		modelAndView.addObject("page", page);
		modelAndView.setViewName("customtestpapermanager");
