...
/**
*  <p>Title: FinalPaperController</p>
*  <p>Description: </p>
*  <p>Company: </p>
*  @author BOY
*  @date 2018年5月29日 下午8:29:00
*/
@Controller
...
public class FinalPaperController {
	...
	private static final String paperType="期末"; 
	...
	public ModelAndView selectAllPapers(String page){
		...
		modelAndView.addObject("finalPapers", selectAllPapers);
		modelAndView.addObject("page", page);
		modelAndView.setViewName("thefinalpapermanager");
