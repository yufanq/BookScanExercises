...
/**
*  <p>Title: KnowledgepointPaperController</p>
*  <p>Description: </p>
*  <p>Company: </p>
*  @author BOY
*  @date 2018年5月30日 上午11:58:02
*/
@Controller
@RequestMapping("/knowledgepointPaper")
public class KnowledgepointPaperController {
	@Autowired
	private PaperService paperService;
	
	private static final String paperType="知识点"; 
	...
	public ModelAndView selectAllPapers(String page){
		...
		modelAndView.addObject("knowledgepointPapers", selectAllPapers);
		modelAndView.addObject("page", page);
		modelAndView.setViewName("knowledgepointestmanager");
