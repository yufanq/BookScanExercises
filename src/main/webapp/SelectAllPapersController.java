...
/**
*  <p>Title: SelectAllPaperController</p>
*  <p>Description:分页查询 </p>
*  <p>Company: </p>
*  @author BOY
*  @date 2018年5月25日 下午3:22:09
*/
@Controller
@RequestMapping("/paper")
public class SelectAllPapersController {
	@Autowired
	...
	public ModelAndView selectAllPapers(String page){
		...
		//获得总条数
		List<Paper> selectAllPapers = paperService.selectAllPapers();
		...
		selectAllPapers=paperService.getPapersByPage(startRow, pageSize);
		
		modelAndView.addObject("selectAllPapers", selectAllPapers);
		modelAndView.addObject("page", page);
		modelAndView.setViewName("testpapers");
